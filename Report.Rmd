...
x <- table(df$FROMNODE[df$FROMNODE %in% buyers$USERS]) # counting the occurances of the users in the TONODE column of other tokens
...
x <- table(df$TONODE[df$TONODE %in% buyers$USERS]) # counting the occurances of the users in the FROMNODE column of other tokens
